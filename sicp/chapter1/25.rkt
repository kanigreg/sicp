...
; Реализация становится медленной
; При увеличении чисел возводимых в степень результат будет большим числом.
; Работа с такими числами подвержена дополнительными затратами.
; В предыдущей реализации результат возведения в степень отсекалось по модулю на каждом шаге,
; поэтому число не выходило за рамки простого типа данных.
